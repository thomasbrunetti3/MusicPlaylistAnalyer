...
namespace MusicPlaylistAnalyzer
{
    public static class MusicStatsLoader
    {
        ...
        public static List<MusicStatsList> Load(string musicPlaylistFilePath)
        {
            List<MusicStatsList> musicStatsList = new List<MusicStatsList>();
                ...
                using (var reader = new StreamReader(musicPlaylistFilePath))
                {
                    ...
                    while (!reader.EndOfStream)
                    {
                        ...
                        try
                        {
                            ...
                            MusicStatsList musicStats = new MusicStatsList(name, artist, album, genre, size, time, year, plays);
